...
public class SoapClient {
  ...
  public static SoapClient testClient(final String serverUri) {
    return new SoapClient(serverUri);
  }

  public SoapClient withHeader(final String key, final String value) {
    headers.put(key, value);
    return this;
  }

  public SoapClient post(final String body) {
    this.body = body;
    return this;
  }
